...
import { 
  Users, TrendingUp, Plus, Briefcase, LogOut, 
  CheckSquare, MessageSquare, Quote, BookOpen, Building, Bell, Search, ArrowRightCircle,
  LayoutDashboard, Star, FileText, PanelLeft
} from 'lucide-react';
...
export default function TecnicosLayout({
  ...
  const isActive = (path: string) => {
    if (path === '/tecnicos/jovens' && pathname === '/tecnicos/jovens/novo') return false;
  ...
  const navGroups = [
    {
      label: 'Principal',
      links: [
        { href: '/tecnicos/painel',          label: 'Painel',           icon: LayoutDashboard },
        { href: '/tecnicos/alertas',         label: 'Alertas Críticos', icon: Bell },
        { href: '/tecnicos/fila-inteligente',label: 'Fila Inteligente', icon: TrendingUp },
      ]
    },
    {
      label: 'Gestão',
      links: [
        { href: '/tecnicos/cadastro/jovens', label: 'Novo Jovem',       icon: Plus },
        { href: '/tecnicos/jovens',          label: 'Jovens',           icon: Users },
        { href: '/tecnicos/empresas',        label: 'Empresas',         icon: Building },
        { href: '/tecnicos/vagas',           label: 'Vagas',            icon: Briefcase },
        { href: '/tecnicos/cursos',          label: 'Cursos',           icon: BookOpen },
      ]
    },
    {
      label: 'Ferramentas',
      links: [
        { href: '/tecnicos/encaminhamento',  label: 'Matching IA',      icon: ArrowRightCircle },
        { href: '/tecnicos/validacao',       label: 'Validação',        icon: CheckSquare },
        { href: '/tecnicos/relatos',         label: 'Relatos WhatsApp', icon: MessageSquare },
        { href: '/tecnicos/depoimentos',     label: 'Depoimentos',      icon: Quote },
        { href: '/tecnicos/relatorios',      label: 'Relatórios',       icon: FileText },
      ]
    },
  ];
        ...
        <div className="px-5 pt-6 pb-4 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-violet-400 font-bold uppercase tracking-wider mt-0.5">Técnico Social</p>
            </div>
          </div>
        </div>
        ...
        <header className="h-[68px] bg-white border-b border-violet-100 flex items-center justify-between px-5 shrink-0 z-10 shadow-sm">
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="search-bar flex items-center px-4 py-2 w-full max-w-sm gap-2.5">
              ...
              <input 
                type="text" 
                placeholder="Buscar jovens, empresas..."
                value={searchVal}
          ...
          <div className="flex items-center gap-4 shrink-0 pl-4">
            ...
            <div className="flex items-center gap-2.5 pl-4 border-l border-violet-100">
              ...
              <div className="hidden sm:flex flex-col">
                <span className="text-sm font-black text-[#1e1b4b]">Lorena Silva</span>
                <span className="text-[10px] font-bold text-violet-400 uppercase tracking-wider">CREAS • Técnica</span>
              </div>
            </div>
          </div>
        </header>
