...
import { 
  Users, Briefcase, LogOut, Bell, Search, Star, PanelLeft, Award
} from 'lucide-react';
      ...
      >
        ...
        <div className="px-5 pt-6 pb-4 shrink-0">
          <div className="flex items-center gap-3">
            <div className="bg-emerald-400 p-2 rounded-xl shadow-lg shadow-emerald-400/30">
              <Star className="h-5 w-5 text-[#1B365D] fill-current" />
            </div>
            <div>
              <h1 className="text-white text-base font-black tracking-tight leading-none">Descubra</h1>
              <p className="text-[10px] text-emerald-400 font-bold uppercase tracking-wider mt-0.5">Portal Empresas</p>
            </div>
          </div>
        </div>
        ...
        <header className="h-[68px] bg-white border-b border-violet-100 flex items-center justify-between px-5 shrink-0 z-10 shadow-sm">
          ...
          <div className="flex items-center gap-4 shrink-0 pl-4">
            <div className="relative cursor-pointer group">
              ...
              <span className="absolute top-1.5 right-1.5 h-3.5 w-3.5 bg-emerald-500 rounded-full border-2 border-white text-[8px] font-black text-white flex items-center justify-center">
                1
              </span>
            </div>

            <div className="flex items-center gap-2.5 pl-4 border-l border-violet-100">
              <div className="h-8 w-8 rounded-full bg-[#1B365D] flex items-center justify-center text-emerald-400 font-bold text-sm shadow-sm select-none">
                S
              </div>
              <div className="hidden sm:flex flex-col">
                <span className="text-sm font-black text-[#1e1b4b]">SEBRAE</span>
                <span className="text-[10px] font-bold text-violet-400 uppercase tracking-wider">Empresa Parceira</span>
              </div>
            </div>
          </div>
        </header>
